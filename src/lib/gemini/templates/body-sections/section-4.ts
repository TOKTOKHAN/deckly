        ...
        <section style="page-break-inside: avoid !important; break-inside: avoid !important; width: 100% !important;">
          ...
          <div class="space-y-2" style="display: flex !important; flex-direction: column !important; gap: 0.5rem !important; width: 100% !important;">
            ${timeline
              .map(
                item => `
            <div class="flex gap-4 p-4 bg-zinc-900/20 border border-white/5 rounded-xl items-center" style="display: flex !important; gap: 1rem !important; padding: 1rem !important; background-color: ${hexToRgba(secondaryColor, 0.2)} !important; border: 1px solid ${hexToRgba(tertiaryColor, 0.2)} !important; border-radius: 0.75rem !important; align-items: center !important;">
          ...
          <div style="width: 100% !important;">
            ...
            <div class="bg-zinc-900/40 p-6 rounded-2xl grid grid-cols-2 gap-4" style="background-color: ${hexToRgba(secondaryColor, 0.4)} !important; padding: 1.5rem !important; border-radius: 1rem !important; display: grid !important; grid-template-columns: repeat(2, minmax(0, 1fr)) !important; gap: 1rem !important; width: 100% !important;">
              ${resources
                .map(
                  resource => `
              <div class="p-4 bg-zinc-950 rounded-xl border border-white/5 text-center" style="padding: 1rem !important; background-color: ${hexToRgba(tertiaryColor, 0.5)} !important; border-radius: 0.75rem !important; border: 1px solid ${hexToRgba(tertiaryColor, 0.2)} !important; text-align: center !important;">
